...
class CustomUserAdmin(UserAdmin):
    ...
    UserAdmin.fieldsets[1][1]['fields']+=('name', 'school', 'phone_num', 'gender', 'point', 'is_mento', 'mento_computing', 'mento_basicC', 'mento_GC', 'mento_basicEngineering', 'mento_univMath', 'mento_principlesodEconomics1', 'mento_principlesodEconomics2')
