    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('respondent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='respondent', to=settings.AUTH_USER_MODEL, verbose_name='답변자')),
